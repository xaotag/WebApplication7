...
namespace WebApplication7.BLL
{
	...
	/// V_Comments_User_BLL
	/// </summary>
	public partial class V_Comments_User_BLL
	{
		private readonly V_Comments_User_DAL dal = new V_Comments_User_DAL();
		public V_Comments_User_BLL()
		{ }
		#region  BasicMethod
		/// <summary>
		/// 是否存在该记录
		...
		/// 获得数据列表
		/// </summary>
		public List<V_Comments_User_Model> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<V_Comments_User_Model> DataTableToList(DataTable dt)
		{
			List<V_Comments_User_Model> modelList = new List<V_Comments_User_Model>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				V_Comments_User_Model model;
